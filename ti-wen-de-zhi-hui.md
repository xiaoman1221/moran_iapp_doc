...
* [声明](broken-reference)
* [简介](broken-reference)
* [在提问之前](broken-reference)
* [当你提问时](broken-reference)
  * [慎选提问的论坛](broken-reference)
  * [Stack Overflow](broken-reference)
  * [网站和 IRC 论坛](broken-reference)
  * [第二步，使用项目邮件列表](broken-reference)
  * [使用有意义且描述明确的标题](broken-reference)
  * [使问题容易回复](broken-reference)
  * [使用清晰、正确、精准且合乎语法的语句](broken-reference)
  * [使用易于读取且标准的文件格式发送问题](broken-reference)
  * [精确地描述问题并言之有物](broken-reference)
  * [话不在多而在精](broken-reference)
  * [别动辄声称找到 Bug](broken-reference)
  * [低声下气不能代替你的功课](broken-reference)
  * [描述问题症状而非你的猜测](broken-reference)
  * [按发生时间先后列出问题症状](broken-reference)
  * [描述目标而不是过程](broken-reference)
  * [别要求使用私人电邮回复](broken-reference)
  * [清楚明确的表达你的问题以及需求](broken-reference)
  * [询问有关代码的问题时](broken-reference)
  * [别把自己家庭作业的问题贴上来](broken-reference)
  * [去掉无意义的提问句](broken-reference)
  * [即使你很急也不要在标题写紧急](broken-reference)
  * [礼多人不怪，而且有时还很有帮助](broken-reference)
  * [问题解决后，加个简短的补充说明](broken-reference)
* [如何解读答案](broken-reference)
  * [RTFM 和 STFW：如何知道你已完全搞砸了](broken-reference)
  * [如果还是搞不懂](broken-reference)
  * [处理无礼的回应](broken-reference)
* [如何避免扮演失败者](broken-reference)
* [不该问的问题](broken-reference)
* [好问题与蠢问题](broken-reference)
* [如果得不到回答](broken-reference)
* [如何更好地回答问题](broken-reference)
* [相关资源](broken-reference)
* [鸣谢](broken-reference)
...
正确地拼写、使用标点和大小写，不要将`its`混淆为`it's`，`loose`搞成`lose`或者将`discrete`弄成`discreet`。不要**全部用大写**，这会被视为无礼的大声嚷嚷（全部小写也好不到哪去，因为不易阅读。[Alan Cox](http://en.wikipedia.org/wiki/Alan\_Cox) 也许可以这样做，但你不行）。
...
请记得，还有其他许多用户没遇到你发现的问题，否则你在阅读文件或搜索网页时就应该发现了（你在抱怨前[已经做了这些，是吧](broken-reference)？）。这也意味着很有可能是你弄错了而不是软件本身有问题。
...
最有效描述程序问题的方法是提供最精简的 Bug 展示测试用例（bug-demonstrating test case）。什么是最精简的测试用例？那是问题的缩影；一小个程序片段能**刚好**展示出程序的异常行为，而不包含其他令人分散注意力的内容。怎么制作最精简的测试用例？如果你知道哪一行或哪一段代码会造成异常的行为，复制下来并加入足够重现这个状况的代码（例如，足以让这段代码能被编译/直译/被应用程序处理）。如果你无法将问题缩减到一个特定区块，就复制一份代码并移除不影响产生问题行为的部分。总之，测试用例越小越好（查看[话不在多而在精](broken-reference)一节）。
...
问题：[我能在哪找到 X 程序或 X 资源？](broken-reference)

问题：[我怎样用 X 做 Y？](broken-reference)

问题：[如何设定我的 shell 提示？](broken-reference)

问题：[我可以用 Bass-o-matic 文件转换工具将 AcmeCorp 文件转换为 TeX 格式吗？](broken-reference)

问题：[我的程序/设定/SQL 语句没有用](broken-reference)

问题：[我的 Windows 电脑有问题，你能帮我吗？](broken-reference)

问题：[我的程序不会动了，我认为系统工具 X 有问题](broken-reference)

问题：[我在安装 Linux（或者 X ）时有问题，你能帮我吗？](broken-reference)

问题：[我怎么才能破解 root 帐号/窃取 OP 特权/读别人的邮件呢？](broken-reference)
...
回答：如果你有足够的智慧提这个问题，你也该有足够的智慧去 [RTFM](broken-reference)，然后自己去找出来。
...
这种问法无非想得到 [STFW](broken-reference) 这样的回答。
